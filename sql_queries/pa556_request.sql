...
drop table if exists jt.pa556_actions;
create table jt.pa556_actions as
...
-- Date Range March 10th - May 3rd
and actions.created >= '2016-03-10'
and actions.created <= '2016-05-03';
...
-- Date Range March 10th - May 3rd
and created >= '2016-03-10'
and created <= '2016-05-03';
-- Total Sends: 16
